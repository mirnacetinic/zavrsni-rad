      ...
      return (
        <div className="w-full max-w-6xl mx-auto p-4">
          <div className="mb-4 flex flex-col items-center md:flex-row">
            ...
            <div className="flex flex-col w-full w-fit h-fit border border-gray-200 rounded p-4">
              ...
              {accommodation.reviews && accommodation.reviews.length > 0 && (
                <>
                  ...
                  <div className="flex flex-row">
                    {accommodation.reviews.slice(0, 3).map((r, i) => ( 
          ...
          {safeUnits.length !== 0 && (
            <div>
              ...
              {safeUnits.map((unit: any, index: number) => (
                <UnitCard key={index} ownerEmail={accommodation.ownerEmail} user={user} unit={unit} />
              ))}
            </div>
          )}
          {theRest.length !== 0 && (
